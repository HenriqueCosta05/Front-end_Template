...
- [ ] Estrutura inicial de uma arquitetura, utilizando design system próprio, baseado no `React Spectrum`, da Adobe.
...
2. Instale as dependências necessárias com NPM:

```bash
cd Front-end_Template && npm i
```

3. Navegue pelo projeto:
